...
halt $zero, $zero, $zero, $zero, 0, 0   # 005
...
beq $zero, $zero, $zero, $imm2, 0, EXIT     #00F
...
EXIT:
add $sp, $sp, $imm2, $zero, 0, 4		# 023    pop 4 items from stack
